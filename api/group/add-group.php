...
if(empty($name) || empty($user_id) || empty($price) || empty($pass_num) || empty($max_num)){
    echo "您有欄位沒有填寫";
    return;
}
...
$sql="INSERT INTO  group_list(name, disc, user_id, pass_num, max_num, is_official, start_time, end_time, activity_start_time) VALUES('$name', '$disc', '$user_id', '$pass_num', '$max_num', 1, '$date','$date1', '$date2')";
